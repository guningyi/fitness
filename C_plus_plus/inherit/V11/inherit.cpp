...
int main(int argc, char **argv)
{
    ...
    /*
 *  虽然CBrassPlus CBrassAus中将showMember()定义成virtual,但CBrass中没有定义为virtual，所以对于pBrass的使用应该是根据指针类型来调用方法。 
 *  pBrass指针调用的是 CBrass::showMember()函数.
 *  所以在CBrassMultiDrived中没有定义showMember()方法也不会导致编译报错。 
 * */
    pBrass->showMember(); 
    delete pBrass;
    return 1;
